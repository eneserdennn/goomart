  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col p-[20px] mb-[20px]">
        <span className="text-[14px] text-[#6D6D6D] font-bold pb-[20px]">
        ...
        {info.map((item, index) => (
          ...
          >
            <div className="flex flex-col">
              <span className="text-primary mb-2">{item.title}</span>
              <span className="text-deepgray">{item.text}</span>
            </div>
            <div></div>
            <div>
      ...
      <span className="text-[14px] text-center text-[#6D6D6D] font-bold pb-[20px]">
        Sosyal Medya
      </span>
