...
const FAQData: FAQItem[] = [
  ...
  {
    question:
      "Uygulama veya siparişlerim ile ilgili size nasıl istekte bulunabilirim?",
    answer:
      "Uygulama veya siparişlerinizle ilgili talepleriniz için iletişim bölümünden bize ulaşabilirsiniz.",
  },
];
