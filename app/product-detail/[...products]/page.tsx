                ...
                {isDiscount ?
                    <div>
                        <div className="flex flex-row items-center">
                            <div className="text-white bg-[#FFA81C] px-2 py-1 rounded-lg text-[14px]">%10</div>
                            <div
                                className="pl-[10px] text-[#AAAAAA] text-[15px] line-through">€{data.mainProductUnitPrice}</div>
                            <div className="pl-[10px] text-primary text-[18px]">€{data.mainProductUnitPrice}</div>
                        </div>
                    </div> : <div>€{data.mainProductUnitPrice}</div>}
            </span>
                </div>
                        ...
                        <div className=" w-full rounded border bg-white">
                            <Disclosure>
                                {({open}) => (
                                    <>
                                        <Disclosure.Button
                                            className="flex w-full h-[60px] pl-[20px] border-b pr-[15px] items-center justify-between rounded py-2 text-left text-[14px] font-bold ">
                        ...
                        isUnitPrice ?
                            <div className="flex justify-center items-center py-2.5">
                                <div className="flex justify-evenly items-center rounded-md w-[188px] h-[52px] border transition duration-150">
                                    <Image src={ICONS.minus} alt={'image'} width={17.25} height={20} onClick={() => {
                                        if (count > 0) {
                                            setCount(count - 1);
                                        }
                                    }}/>
                                    ...
                                    <Image src={ICONS.plus} alt={'image'} width={17.25} height={20} onClick={() => {setCount(count + 1)}}/>
                                </div>
                            </div>
