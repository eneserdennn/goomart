        ...
        <>
          <div className="flex flex-row items-center bg-[url('/settingsFrame.svg')] h-[103px] px-10">
            <div className="flex items-center">
              <div className="rounded-full bg-white border h-[50px] w-[50px] flex items-center justify-center text-2xl font-bold text-primary">
                {userNameInitials}
              </div>
              ...
              {({
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="flex flex-col px-4">
                    ...
                    <span className="text-deepgray text-[15px] font-semibold py-3 cursor-pointer hover:underline">
                      Sifre Degistir
                    </span>
                    ...
                    <div className="flex items-center mb-4">
                      <input
                        ...
                        className={`w-full px-4 py-3 border rounded-md outline-none focus:ring-2 focus:ring-primary ${
                    ...
                    <div className="relative items-center w-full h-[51px] mb-4">
                      <input
                        ...
                        className={`w-full px-4 py-3 mb-4 border rounded-md outline-none focus:ring-2 focus:ring-primary ${
