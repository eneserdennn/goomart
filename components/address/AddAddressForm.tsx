...
const validationSchema = Yup.object().shape({
    ...
    postalCode: Yup.string().required('Posta Kodu zorunludur').max(5, 'Posta Kodu 5 haneli olmalıdır'),
        ...
        if (lastPartOfUrl !== 'add-address') {
            ...
            if(isFetchedAddress) {
                ...
                setSelectedCountry({
                    ...
                    label: (address?.address?.country.name.charAt(0).toUpperCase() + address?.address?.country.name.slice(1)) || '',
                    ...
                    <div className="flex w-full flex-col mr-4">
                        ...
                        <div>
                            {formik.errors.fullName ?
                                <div className="text-red-500 text-sm">{formik.errors.fullName}</div> : null}
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    />
                    {formik.errors.address ? <div className="text-red-500 text-sm">{formik.errors.address}</div> : null}
                </div>
                ...
                <div className="flex w-full flex-col mr-4">
                    ...
                    >
                        <div className="flex flex-row items-center">
                            <Image src={ICONS[selectedCountry.code]} alt={selectedCountry.code} className="h-6 w-6"/>
                            <span className="text-[16px] ml-4">{selectedCountry.label}</span>
                        </div>
                    </IconButton>
                </div>
            ...
            {showModal && (<div className="fixed inset-0 flex items-center justify-center z-50">
                ...
                <div className="bg-white rounded-lg w-5/6 md:max-w-md mx-auto p-4 z-10 flex flex-col items-center">
                    ...
                    <p className="text-center mb-2">
                        Adres bilgilerinizi eksiksiz ve dogru girdiginize emin misiniz?
                    </p>
                    ...
                    <div className="flex justify-center mt-6 space-x-4 w-full">
                        <button className="px-4 py-2 text-primary w-full" onClick={handleModalCancel}>
                            Vazgeç
                        </button>
                        <Button
