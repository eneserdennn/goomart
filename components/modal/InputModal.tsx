...
const InputModal: React.FC<InputModalProps> = ({ show, onClose, onConfirm, inputValue, onInputChange, hasCancelButton = true, buttonText = "Evet", icon }) => {
    return show ? (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white rounded-2xl w-[324px] h-[200px] z-10 flex flex-col items-center">
                <div className="bg-white rounded-full p-3 pb-[25px] -mt-[36px] ">
                    {icon ? icon : <Image src={ICONS.warning} alt={"warning"} className="h-[56px] w-[56px]"/>}
                </div>
