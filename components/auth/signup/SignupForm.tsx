      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          firstName: Yup.string()
            ...
            .max(50, "Ad alanı çok uzun"),
          lastName: Yup.string()
            .required("Soyad alanı zorunlu")
            .max(50, "Soyad alanı çok uzun"),
          email: Yup.string()
          ...
          <>
            <form className="w-full" noValidate onSubmit={handleSubmit}>
              ...
              <div className="flex items-start">
                ...
                <label className="flex items-center mt-2">
                  ...
                  <span className="m-4 text-sm font-nunito">
                    Bana özel kampanya, tanıtım ve fırsatlardan haberdar olmak
                    istiyorum.
                  </span>
                </label>
              ...
              <span className="text-sm mb-2">
                Üye olmakla,
                <span className="text-primary mx-1">Kullanım Koşulları</span>
                hükümlerini kabul etmektesiniz.
              </span>
              <Button className="my-6" style={{ fontSize: "1.1rem" }}>
                Kayıt Ol
              </Button>
